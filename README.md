...
Please refer to [Understanding the JSON elements](/wikis/understanding-json-element) in our wiki for details.

Once you understood the json elements, you can refer to [How to convert SQL to JSON](/wikis/how-to-convert-sql-to-json) to write JSON for respective SQL 
